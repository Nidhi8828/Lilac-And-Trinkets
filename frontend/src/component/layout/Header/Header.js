            ...
            <div className="header1">
                ...
                <div>
                    <ul>
                        ...
                        <li><a href="./search" className="notextdec"><i className="fa-solid fa-magnifying-glass black-text"></i></a></li>
                        <li><a href="./cart" className="notextdec"><i className="fa-solid fa-cart-shopping black-text"></i></a></li>
                    </ul>
                </div>
            </div>
